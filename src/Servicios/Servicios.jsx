...
wow.init()
 ...
 <div className="row">
                <div id="segunda" className="col col-md-4 wow animate__animated animate__backInLeft">
                ...
                <div id="primera" className="col col-md-4 wow animate__animated animate__backInDown">
                ...
                <div id="tercera" className="col col-md-4 wow animate__animated animate__backInRight">
